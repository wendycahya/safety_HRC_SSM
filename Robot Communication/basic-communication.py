...
def example_move():
    ...
    while (not target_reached):
        ...
        if (isclose(tcp_x, TARGET_1_X, abs_tol=TRANSLATION_TOLERENCE) and isclose(tcp_y, TARGET_1_Y,
                                                                                  abs_tol=TRANSLATION_TOLERENCE) and
                isclose(tcp_z, TARGET_1_Z, abs_tol=TRANSLATION_TOLERENCE) and isclose(tcp_theta_x, TARGET_1_THETA_X,
                                                                                      abs_tol=ORIENTATION_TOLERENCE) and
                isclose(tcp_theta_y, TARGET_1_THETA_Y, abs_tol=ORIENTATION_TOLERENCE) and isclose(tcp_theta_z,
                                                                                                  TARGET_1_THETA_Z,
                                                                                                  abs_tol=ORIENTATION_TOLERENCE)):
            target_reached = True
    ...
    while (not target_reached):
        ...
        if (isclose(tcp_x, TARGET_2_X, abs_tol=TRANSLATION_TOLERENCE) and isclose(tcp_y, TARGET_2_Y,
                                                                                  abs_tol=TRANSLATION_TOLERENCE) and
                isclose(tcp_z, TARGET_2_Z, abs_tol=TRANSLATION_TOLERENCE) and isclose(tcp_theta_x, TARGET_2_THETA_X,
                                                                                      abs_tol=ORIENTATION_TOLERENCE) and
                isclose(tcp_theta_y, TARGET_2_THETA_Y, abs_tol=ORIENTATION_TOLERENCE) and isclose(tcp_theta_z,
                                                                                                  TARGET_2_THETA_Z,
                                                                                                  abs_tol=ORIENTATION_TOLERENCE)):
            target_reached = True
