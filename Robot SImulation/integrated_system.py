        ...
        if faces:
           ...
           #skeleton mediapipe migrasion
                ...
                # ===== SSM calculation ======
                    ...
                    Vrmax = Vr_max(Sp, Vh, VelRnew, Tr, ac, C, Zd, Zr)


    # ===== Visualization information ======
                # ===== background information =====
                    cv2.rectangle(img, (8, 0), (250, 120), (255, 255, 255), -1)
                    cv2.rectangle(img, (360, 0), (600, 100), (255, 255, 255), -1)
                ...
                # left monitoring input
                    ...
                    distView = eye_dist
                    cv2.putText(img, 'Distance (z) = ' + str(round(distView, 4)) + ' mm',
                                (10, 100),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 255), 1, cv2.LINE_AA
                                )
                ...
                #  right monitoring output
                    ...
                    cv2.putText(img, 'Sp = ' + str(Spmin) + ' mm',
                                (425, 40),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 255), 1, cv2.LINE_AA
                                )
                    cv2.putText(img, 'dist HR = ' + str(round(distView, 4)) + ' mm',
                                (425, 60),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 255), 1, cv2.LINE_AA
                                )

                    cv2.putText(img, 'Vrmax = ' + str(round(Vrmax, 5)) + ' mm/s',
                                (425, 80),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 255), 1, cv2.LINE_AA
                                )
                    ...
                    if Scurrent < Spmin:
                        ...
                        cv2.circle(img, (380, 40), radius=10, color=(255, 165, 0), thickness=20)
